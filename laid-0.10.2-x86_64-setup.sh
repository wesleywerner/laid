...
echo -e "LAID x86_64 version $LAIDVERSION log $(date)" 2>&1 | tee log.txt

export LOVE_SOURCE_URL=https://bitbucket.org/rude/love/get/0.10.2.tar.gz
export CARE_URL=https://github.com/proot-me/proot-static-build/raw/master/static/care-x86_64
export APPIMAGE_TOOL_URL=https://github.com/AppImage/AppImageKit/releases/download/continuous/appimagetool-x86_64.AppImage
